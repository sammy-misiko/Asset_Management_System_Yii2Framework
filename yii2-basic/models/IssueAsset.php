...
/**
 * This is the model class for table "issue_asset".
 *
 * @property int $id
 ...
 */
class IssueAsset extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return IssueAssetQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new IssueAssetQuery(get_called_class());
    }
}
