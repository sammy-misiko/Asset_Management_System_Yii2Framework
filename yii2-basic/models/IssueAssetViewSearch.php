...
/**
 * IssueAssetViewSearch represents the model behind the search form of `app\models\Myassets`.
 */
class IssueAssetViewSearch extends Myassets
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['serialno', 'name', 'model', 'state', 'assettag', 'region_from', 'project_type', 'received_date', 'supplier', 'purchase_date'], 'safe'],
